...
To view a copy of this dedication, visit https://creativecommons.org/publicdomain/zero/1.0/ or send a letter to Creative Commons, PO Box 1866, Mountain View, CA 94042, USA.
...
You can:
* **Copy, modify, and distribute** the work, even for commercial purposes, **without asking permission**.
* **Use it freely** with no attribution required.

No warranties are given. The work is provided as-is.

### Creator Attribution Notice (optional, not required):
Semantic Manifest Specification (v0.1) originally proposed by Chris Limner / Hypersonic SEO, 2026. Attribution is appreciated but not required under this license.
